...
export const OfferNewFeatureForm = ({ handleSuccessPopup }: TProps) => {
  ...
  const onSubmit = (data: { message: string }) => {
    ...
    const dto = {
      ...
      userName,
      theme: 'Предлагаю новый функционал'
    };
        ...
        <form onSubmit={methods.handleSubmit(onSubmit)}>
          <ul style={{ width: '100%' }}>
            <li>
              <ControlledTextArea
                name="message"
                placeholder={`Описание функции... ${!userEmail && 'В конце добавьте свой email, по желанию'}`}
                rows={9}
                maxLength={250}
              />
            </li>
